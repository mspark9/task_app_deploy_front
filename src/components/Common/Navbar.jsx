            ...
            <ul className='menus'>
                {
                    navMenus.map((menu, idx) => (
                        <li key={idx} className={`rounded-sm mb-2 border border-gray-700 hover:bg-gray-950 transition-all duration-300 ${isActive(menu.to) ? 'bg-gray-950' : ''
                            }`}>
            ...
            </ul>
            {
                isAuth ? (
                    <div className='auth-button w-4/5 flex items-center'>
                        <button type='button' className='flex justify-center items-center gap-2 bg-gray-300 text-gray-900 py-3 px-4 rounded-md w-full' onClick={handleLogoutClick}>
